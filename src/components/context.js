...
setcart([...updatedCart])
  ...
  return (
   <ProductContext.Provider value={{...state,handleDetails:handleDetails,addToCart:addToCart,openModel:openModel,closeModel:closeModel,increment:increment,decrement:decrement,removeItem,removeItem,clearCart:clearCart,cart:cart}} >
    {props.children}
